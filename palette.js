...
const DEFAULT_PALETTE = {
  ...
  categories: {
    ...
    flora:        { hint: 'trees, plants, bushes, flowers, roots, moss',                 style: 'crisp 3/4 hero product photo of a single whole plant, full plant visible from base to top, isolated on a pure white seamless background, no floor, no shadow, soft diffuse lighting, detailed bark and foliage, realistic three-dimensional form, 8k sharp focus', target_face_num: 28000, cfg: 3.5, steps: 20, builtin: true },
